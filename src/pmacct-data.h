...
static const struct _dictionary_line dictionary[] = {
  ...
  {"bgp_daemon_as", cfg_key_nfacctd_bgp_as},
  ...
  {"bgp_daemon_offline_input", cfg_key_nfacctd_bgp_offline_input},
  {"bgp_daemon_offline_file_spool", cfg_key_nfacctd_bgp_offline_file_spool},
  {"bgp_daemon_offline_file_refresh_time", cfg_key_nfacctd_bgp_offline_file_refresh_time},
  ...
  {"bgp_src_lrg_comm_type", cfg_key_nfacctd_bgp_src_lrg_comm_type},
